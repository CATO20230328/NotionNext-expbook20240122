...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '8e02154cf5d94d7da92691222ce4767a',
  ...
  FACEBOOK_PAGE_ID: process.env.NEXT_PUBLIC_FACEBOOK_PAGE_ID || '237551996105262', // Facebook Page ID 來啟用 messenger 聊天功能
  FACEBOOK_APP_ID: process.env.NEXT_PUBLIC_FACEBOOK_APP_ID || '314094101664621', // Facebook App ID 來啟用 messenger 聊天功能 获取: https://developers.facebook.com/
  ...
  GALLERY_BEAUTIFICATION: process.env.GALLERY_BEAUTIFICATION || true, // 画册视图美化与功能增强
